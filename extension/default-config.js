window.DEFAULT_ROSE_BPS_CONFIG = {
  ...
  "fieldMap": [
    ...
    {
      "paths": [
        "substance_use.substance_3.substance"
      ],
      "fillIndex": 35
    },
    {
    ...
    {
      "paths": [
        "symptoms_suicide_self_harm.attempt_dates_and_methods",
    ...
    {
      "paths": [
        "symptoms_suicide_self_harm.future_attempt_triggers"
      ],
      "fillIndex": 118,
      "dataQnFieldId": "10118"
    },
  ...
  "notes": [
    ...
    "Conditional n/a defaults for no PCP and missing second or third substances live in prompt rules because flat defaultAnswers cannot safely express those conditions.",
  ...
  "releaseNotes": [
    ...
    "v0.4.3 updates conditional n/a prompt defaults for PCP clinic/doctor fields when no primary care doctor is reported, and for substance_2/substance_3 age_first_use when those substances are not reported.",
    ...
    "v0.4.5 enforces Part 1 runtime defaults for PCP unknowns, client-name narratives, mental-health n/a follow-ups, medication mixing, STD resources, dentist/spiritual/tobacco defaults, and the corrected Substance 3 field mapping.",
    "v0.4.6 clarifies Part 1 three-substance mapping: substance_1/substance_2 keep combined Substance: age values in age_first_use, substance_3 returns separate substance plus age fields, and runtime splits combined third-substance fallbacks.",
    "v0.4.7 corrects the Part 1 suicide-attempt sequence: dates and methods share one ReliaTrax textbox, under-influence through protective-factor answers use the correct controls, and future attempt triggers have a dedicated response field.",
    "v0.4.8 prevents older or unsafe remote BPS configurations from replacing the protected suicide-attempt mapping.",
    "v0.4.9 adds Prompt 1 completeness safeguards and requires Prompt 2 to use the current combined suicide-attempt keys while retaining legacy runtime compatibility."
  ]
};
