  ...
  "modes": {
    ...
    "asam": {
      ...
      "sourcePrompt": {
        ...
        "body": "You are creating structured JSON for Rose's ReliaTrax Biopsychosocial Assessment Part 3: Case Management Assessment and ASAM Criteria from the transcript provided.\n\nReturn one valid JSON object only. Do not include markdown, comments, prose outside JSON, trailing commas, or keys outside the requested JSON shape. Keep all narrative content copy/paste ready for the EHR form. Use the client's first name in narrative fields when known. Write in third person using professional clinical language and reports/denies/endorses wording when clinically appropriate. Avoid em dashes.\n\nComplete every item. Do not skip, combine, summarize away, or omit any category or ASAM dimension. Use clinical inference when the transcript supports it, especially for withdrawal potential, tolerance, functional impact, relapse risk, readiness, environmental risk, educational/vocational impact, and trauma or grief impact. Apply ASAM ratings with a cautious clinical calibration: when evidence reasonably sits between two adjacent severity levels, choose the higher supported level and explain the functional risk. If there is no basis to infer a specific detail, use Information not provided inside the rationale rather than leaving a field blank.\n\nUse this exact top-level shape:\n{\n  \"case_management\": {\n    \"items\": {\n      \"housing\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"financial_stressors\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"legal\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"employment\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"education_vocation\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"independent_living\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"medical\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"social_natural_supports\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" }\n    },\n    \"asam_criteria\": {\n      \"dimension_1\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_2\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_3\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_4\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_5\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_6\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" }\n    },\n    \"safety_planning\": {\n      \"additional_safety_planning_needed\": \"No\",\n      \"why_or_why_not\": \"\"\n    }\n  }\n}\n\nCase Management Assessment formatting rules:\n- Complete exactly these eight Functioning categories: Housing, Financial Stressors, Legal, Employment, Education/Vocation, Independent Living, Medical, and Social/Natural Supports.\n- Each item must use score 0, 1, 2, or 3 and matching severity label None, Mild, Moderate, or Severe.\n- The rationale must be one concise clinical sentence. If rendered as text, it must correspond to this original format: <Category>: <0-3> (<None/Mild/Moderate/Severe>) - <one sentence>.\n- Select one severity per category. Do not mark multiple severities for the same category.\n\nFunctioning score guide:\n- Housing: 0 stable; 1 temporary or recently unstable but currently housed; 2 unstable, temporary, unsafe, or at risk of losing housing; 3 currently homeless or without a safe stable residence.\n- Financial Stressors: 0 stable; 1 mild strain; 2 moderate strain, unemployment, inconsistent income, or difficulty meeting obligations; 3 no income, benefits absent, or basic needs unmet.\n- Legal: 0 none; 1 minor or resolved; 2 active case, probation, parole, pretrial, or unresolved legal stressor; 3 severe impact such as incarceration risk, repeated legal consequences, or legal barriers disrupting stability.\n- Employment: 0 stable; 1 mild work disruption; 2 unemployed and seeking, underemployed, or work instability affecting functioning; 3 not seeking, unable to work, or major barriers preventing employment.\n- Education/Vocation: 0 none or stable participation; 1 mild disruption; 2 moderate disruption, dropped/paused education, or vocational barriers affecting stability; 3 severe educational/vocational impairment.\n- Independent Living: 0 independent; 1 mild support needs; 2 moderate support needs, difficulty maintaining routines/basic needs, or housing instability affecting self-management; 3 unable to manage basic needs without substantial support.\n- Medical: 0 none; 1 mild or stable condition/medication need; 2 moderate symptoms, missed care, no PCP with active needs, or medical issues interfering with functioning; 3 severe or unmanaged medical impairment.\n- Social/Natural Supports: 0 strong sober/recovery support; 1 some support with gaps; 2 limited, inconsistent, or not recovery-oriented support; 3 no meaningful support or supports actively undermine safety/recovery.\n\nASAM Criteria formatting rules:\n- Complete all six ASAM dimensions individually.\n- Severity must use 0 None, 1 Mild, 2 Moderate, 3 High, or 4 Severe. The label field must exactly match the severity number.\n- Each dimension text must use this exact internal format: Severity: <number>: <label>\n\n<2-4 sentence clinical paragraph>\n- Each paragraph must justify the rating, describe current functioning, include risk implications, and support the least restrictive safe level of care.\n- Do not inflate severity and do not minimize severity. Ratings must align with the transcript, case management functioning scores, DSM/SUD evidence, safety planning, and likely level of care.\n- Err on the side of clinical caution when the transcript shows current or recent homelessness, recent substance use, untreated mental health symptoms, active legal involvement, unemployment, financial instability, disrupted basic needs, or weak recovery supports. These factors usually mean there is more than a 0 or 1 risk in the related dimensions unless the transcript clearly shows the client is stable and coping well.\n- Do not rate too high: severity 4 requires imminent danger, incapacitation, inability to function independently, severe withdrawal/medical/psychiatric instability, or an unsafe environment that immediately threatens safety. Housing instability alone does not justify severity 4.\n- Sober living is not a clinical level of care. MAT can occur at any level of care.\n\nASAM dimension labels:\n- dimension_1: Acute Intoxication and/or Withdrawal Potential.\n- dimension_2: Biomedical Conditions and Complications.\n- dimension_3: Emotional, Behavioral, or Cognitive Conditions and Complications.\n- dimension_4: Readiness to Change.\n- dimension_5: Relapse, Continued Use, or Continued Problem Potential.\n- dimension_6: Recovery/Living Environment.\n\nASAM severity criteria to apply:\n- Severity 0 None/no risk: fully functioning in that dimension with no current risk or no clinically meaningful support need.\n- Severity 1 Mild/low risk: a condition, symptom, vulnerability, or support need is present, but the client is generally coping and the issue can be managed safely with outpatient supports.\n- Severity 2 Moderate risk: symptoms, instability, barriers, or relapse/environmental factors interfere with functioning or recovery, and the client needs structured clinical support or prompting but does not require 24-hour care for that dimension.\n- Severity 3 High risk: the client has poor coping, severe/worsening symptoms, high likelihood of relapse, major functional impairment, homelessness/unsafe recovery environment, or inconsistent ability to follow recommendations, but the record does not show imminent danger requiring inpatient care.\n- Severity 4 Severe risk: use only for incapacitation, imminent danger, severe withdrawal/medical/psychiatric instability, inability to function independently, or an environment/continued use pattern that immediately threatens safety.\n- Dimension 1, Acute Intoxication and/or Withdrawal Potential: 0 means no current intoxication or withdrawal signs and fully functioning. 1 means mild or manageable intoxication/withdrawal risk, minimal severe withdrawal risk, or needs safely managed with outpatient support/MAT. 2 means intoxication or withdrawal risk interferes with functioning, creates difficulty coping, or needs structured monitoring but responds to support and does not create immediate danger. 3 means severe or worsening intoxication/withdrawal signs, poor ability to cope, recent high-risk use with significant withdrawal concern, or risk that may require close monitoring. 4 means incapacitated, severe withdrawal danger such as seizures or delirium tremens, or continued use posing imminent threat to life.\n- Dimension 2, Biomedical Conditions and Complications: 0 means no biomedical problems or fully able to cope. 1 means stable mild/moderate physical discomfort, pain, medication needs, or medical follow-up needs with limited functional impact. 2 means acute non-life-threatening symptoms, difficulty tolerating physical problems, neglected medical needs, lack of needed care with active symptoms, or medical issues that interfere with functioning. 3 means severe but stable medical problems, poor ability to cope, serious problems neglected during outpatient care, or medical complexity needing high structure. 4 means incapacitating or unstable medical problems requiring inpatient medical care.\n- Dimension 3, Emotional, Behavioral, or Cognitive Conditions and Complications: 0 means good impulse control and coping with no safety risk. 1 means a suspected or diagnosed condition needs intervention but does not significantly interfere with treatment or safety. 2 means persistent symptoms, untreated mental health needs, trauma/grief impact, attention/cognitive barriers, or mood/anxiety symptoms that distract from recovery or functioning but do not create immediate danger. 3 means severe symptoms, poor impulse control, impaired coping, repeated inability to manage symptoms, or risk of harm that requires high structure but not necessarily involuntary care. 4 means severe acute symptoms, imminent danger to self or others, or inability to function independently.\n- Dimension 4, Readiness to Change: 0 means willing, engaged, and responsible in treatment. 1 means willing to enter treatment or explore change while ambivalent. 2 means reluctant, passively involved, low commitment, external motivation, or able to identify consequences but inconsistent in follow-through. 3 means minimal awareness of need for change, poor engagement, inconsistent follow-through, or only partial ability to follow recommendations. 4 means unwilling to explore change, denial of illness/implications, inability to follow recommendations, or immediate action needed because risk is high.\n- Dimension 5, Relapse, Continued Use, or Continued Problem Potential: 0 means low/no relapse potential with good coping skills. 1 means minimal relapse potential, some vulnerability, and fair self-management. 2 means impaired recognition of relapse signs, cravings/triggers, limited relapse-prevention skills, or continued-problem vulnerability that can be self-managed with prompting or structure. 3 means little recognition of relapse risk, poor coping skills, recent continued use/relapse, high-risk polysubstance pattern, or high likelihood of relapse without structured intervention. 4 means no coping skills, inability to interrupt use, or continued addictive behavior creating imminent danger to self or others.\n- Dimension 6, Recovery/Living Environment: 0 means supportive environment or able to cope in current environment. 1 means passive or limited support but the client can cope. 2 means non-supportive, unstable, or recently homeless environment where the client can cope most of the time with clinical help. 3 means non-supportive, unstable, currently homeless, hostile, substance-exposed, unsafe, or high-risk environment where coping is difficult even with clinical structure. 4 means chronically hostile, toxic, or unsafe environment where the client cannot cope and safety or recovery is immediately threatened.\n\nLevel of care alignment:\n- First consider emergency or safety needs, then recommend the least intensive level that can safely and effectively address the ASAM profile.\n- Level I Outpatient generally fits when dimensions are mostly 0 or 1 and the client can function safely with outpatient supports.\n- IOP 2.1 often fits when Dimension 1 and 2 are 0 or 1, Dimension 3 is 1 or 2, and Dimension 4, 5, or 6 is 3 or 4 because the client needs 6-20 hours of structured treatment per week.\n- Partial hospitalization or residential levels require stronger clinical support, such as a 3 or 4 in Dimensions 1, 2, or 3 plus additional high-risk dimensions, or a documented need for 24-hour clinical structure.\n- Homelessness or lack of a safe supportive recovery environment may support higher structure when the client cannot cope safely in the community, but housing need by itself is not the same as medical necessity for residential treatment.\n- Inpatient or detox is indicated when acute withdrawal, biomedical, psychiatric, or safety risk cannot be safely managed in a lower level.\n- Do not recommend a higher level of care without transcript support. Do not treat housing needs alone as residential treatment.\n\nSafety planning rules:\n- additional_safety_planning_needed must be exactly Yes or No.\n- why_or_why_not must be a clinical explanation that matches the transcript and references relevant safety factors such as SI/HI, withdrawal risk, medical concerns, self-harm risk, violence risk, relapse risk, psychiatric instability, environmental concerns, or the absence of those risks.\n- Do not use generic safety language. If No, explain why additional safety planning is not clinically indicated. If Yes, describe the active concern and immediate planning need.\n\nRole clarity and SUD rules:\n- The clinician assesses, diagnoses, plans, and refers. Do not imply the clinician guarantees housing, employment, or other outcomes.\n- Housing decisions belong to sober living or housing staff. The client is responsible for follow-through. Peer support assists connection only.\n- Any SUD history, even remission, qualifies for SUD consideration. Sobriety alone does not rule out SUD.\n- If there is no SUD history or no SUD criteria, do not recommend peer services, SUD groups, IOP, or substance programming in the ASAM rationale. Use referral-out or non-SUD resources and 30-day transition logic.\n\nBefore finalizing, verify the JSON is valid, every required item is present, each score/label pair matches, every ASAM dimension includes a Severity line plus a 2-4 sentence paragraph, and no extra keys are present."
      },
