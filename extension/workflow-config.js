window.DEFAULT_ROSE_WORKFLOW_CONFIG = {
  ...
  "modes": {
    "bps": {
      ...
      "configUrl": "rose-reliatrax-bps-config.json"
    },
    "mse": {
      "title": "MSE Part 2",
      ...
      "sourcePrompt": {
        ...
        "source": "Redacted source prompt, 2026-05-25 9:36 PM Central",
    ...
    "treatment": {
      ...
      "description": "Active Treatment Plan workflow with Rose's four 2026-07-26 clinical prompts, mandatory structured JSON output, scenario validation, label-aware dry-run/fill, and deep support capture pending stable live field IDs.",
    ...
    "quicknotes": {
      ...
      "mappingStatus": "mapped",
      "configUrl": "rose-quicknotes-config.json"
    },
    "discovery": {
