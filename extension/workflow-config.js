window.DEFAULT_ROSE_WORKFLOW_CONFIG = {
  ...
  "modes": {
    ...
    "asam": {
      ...
      "description": "Mapped Case Management Assessment workflow for Functioning scores, ASAM Criteria dimensions, and additional safety planning fields from Rose files received 2026-05-31.",
      "mappingStatus": "mapped",
      "fieldMap": [
        {
          "fillIndex": 455,
      ...
      "sourcePrompt": {
        ...
        "source": "notes/05-31-2026 Promp_3.txt, Prompt3_and_4.txt, ASAM PDFs, and 05-31-26_Part_3.JSON",
        "body": "You are creating structured JSON for Rose's ReliaTrax Biopsychosocial Assessment Part 3: Case Management Assessment.\n\nReturn one valid JSON object only. Do not include markdown, comments, prose outside JSON, or trailing commas. Use the client's first name in narrative fields when known. Write professional clinical language in third person. Avoid em dashes.\n\nUse this exact top-level shape:\n{\n  \"case_management\": {\n    \"items\": {\n      \"housing\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"financial_stressors\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"legal\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"employment\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"education_vocation\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"independent_living\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"medical\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" },\n      \"social_natural_supports\": { \"score\": 0, \"severity\": \"None\", \"rationale\": \"\" }\n    },\n    \"asam_criteria\": {\n      \"dimension_1\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_2\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_3\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_4\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_5\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" },\n      \"dimension_6\": { \"severity\": 0, \"label\": \"None\", \"text\": \"\" }\n    },\n    \"safety_planning\": {\n      \"additional_safety_planning_needed\": \"No\",\n      \"why_or_why_not\": \"\"\n    }\n  }\n}\n\nFunctioning scoring is strict. Complete every category: Housing, Financial Stressors, Legal, Employment, Education/Vocation, Independent Living, Medical, and Social/Natural Supports. Use score 0 None, 1 Mild, 2 Moderate, 3 Severe. The severity label must match the score. The rationale must be one concise clinical sentence. Score guide: Housing 0 stable, 1 temporary, 2 unstable, 3 homeless. Financial Stressors 0 stable, 1 mild, 2 moderate, 3 no income or basic needs unmet. Legal 0 none, 1 minor, 2 active, 3 severe impact. Employment 0 stable, 1 mild, 2 seeking, 3 not seeking or barriers. Education/Vocation 0 none, 1 mild, 2 moderate, 3 severe. Independent Living 0 independent, 1 mild, 2 moderate, 3 unable. Medical 0 none, 1 mild, 2 moderate, 3 severe. Social/Natural Supports 0 strong, 1 some, 2 limited, 3 none.\n\nASAM Criteria is strict. Complete all six ASAM dimensions. Severity must use 0 None, 1 Mild, 2 Moderate, 3 High, 4 Severe, and the label must match the number. Each dimension text must begin with \"Severity: <number>: <label>\" and then include a 2-4 sentence clinical paragraph. Each paragraph must justify the rating, describe functioning, include risk implications, and support the recommended level of care. Do not inflate severity and do not minimize severity. Use the least restrictive safe level of care logic: Level I Outpatient is generally all 0/1; IOP 2.1 often has low Dimension 1/2 with higher Dimension 4, 5, or 6; residential or inpatient require stronger acute risk or 24-hour clinical structure needs. Sober living is not a clinical level of care.\n\nDimension 1 is Acute Intoxication and/or Withdrawal Potential. Dimension 2 is Biomedical Conditions and Complications. Dimension 3 is Emotional, Behavioral, or Cognitive Conditions and Complications. Dimension 4 is Readiness to Change. Dimension 5 is Relapse, Continued Use, or Continued Problem Potential. Dimension 6 is Recovery/Living Environment.\n\nSafety planning must be individualized. additional_safety_planning_needed must be exactly Yes or No. If additional_safety_planning_needed is No, why_or_why_not must be exactly \"<Client first name> denies being a suicide risk\" with the client's first name and no other wording. Do not write \"<Client> is not a suicide risk.\" If additional_safety_planning_needed is Yes, why_or_why_not must describe the active safety concern and should reference SI/HI, withdrawal risk, medical concerns, self-harm risk, violence risk, relapse risk, psychiatric instability, environmental concerns, or the clinically relevant concern requiring safety planning. Do not use generic safety language.\n\nRole clarity: the clinician assesses, diagnoses, plans, and refers. Do not imply the clinician ensures housing outcomes. Housing decisions belong to sober living staff. The client is responsible for follow-through. Peer support assists connection only.\n\nSUD rule: any SUD history, even remission, qualifies. Sobriety alone does not rule out SUD. If there is no SUD, do not recommend peer services, SUD groups, IOP, or substance programming; use referral-out or non-SUD resources and 30-day transition logic."
      },
