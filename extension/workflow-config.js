window.DEFAULT_ROSE_WORKFLOW_CONFIG = {
  ...
  "modes": {
    ...
    "asam": {
      ...
      "description": "Mapped Case Management Assessment workflow for Functioning scores, ASAM Criteria dimensions, and additional safety planning fields from Rose files received 2026-05-31. Source prompt reoriented to the original Part 3 formatting and ASAM criteria references.",
      "mappingStatus": "mapped",
      "fieldMap": [
        {
          "fillIndex": 455,
